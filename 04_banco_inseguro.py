# -*- coding: utf-8 -*-
"""
Created on Sun Aug 15 14:28:24 2021

@author: ricar
"""

'''
exercício segurança threads
'''
...
def valida_banco(contas: List[Conta], total: int):
    ...
    if atual != total:
        print('ERRO balanco inconsistente ', atual - total)
    else:
        print('Balanço bancário consistente ', atual - total, atual)
