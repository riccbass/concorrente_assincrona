...
def main():
    ...
    [th.start() for th in threads] # adiciona a thread na pool na thread prontas para a execução #3
    print('podemos fazer outras coisas no programa enquanto a thread vai executando')
    print('Geek university ' * 2)
    
    [th.join() for th in threads] #avisa para ficar executando aqui enquanto a thead está executando #4
